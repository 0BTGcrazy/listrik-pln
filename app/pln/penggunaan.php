...
// echo $next_tahun."-".$next_bulan."-".$mawal."-".@$id_pel."";

@$id_pelanggan = $_POST['id_pelanggan'];
@$meter_akhir = $_POST['meter_akhir'];
@$meter_awal = $_POST['meter_awal'];
@$tgl_cek = $_POST['tgl_cek'];
@$total_pemakaian = floatval($meter_akhir) - floatval($meter_awal);
...
if (isset($_POST['bubah'])) {
	// echo "".$id_penggunaan_next."-".$bulan."-".$tahun;
							...
							<form method="post">
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" name="id_pelanggan" class="form-control" placeholder="Masukan ID Pelanggan" onchange="submit()" required value="<?php if (@$_GET['id'] == "") {
																																												echo @$id_pel;
																																											} else {
