	...
	<div class="container-fluid">
		<div class="row">
			...
			<?php  
				...
				if ($pelanggan && isset($pelanggan['id_tarif'])) {
					$tarif = $aksi->caridata("tarif WHERE id_tarif = '{$pelanggan['id_tarif']}'");
				} else {
					echo "<div class='alert alert-danger'>Tarif tidak ditemukan karena data pelanggan tidak valid.</div>";
				}
					if($pelanggan==""){
									...
									<div class="col-md-3">
										...
										<table class="table table-striped table-hover" align="center">
											...
											<tr>
												...
												<td width="5%">:</td>
												<td align="left"><?php echo $tarif['kode_tarif'].""; $aksi->rupiah($tarif['tarif_perkwh']); ?></td>
											</tr>
										</table>
									</div>
									<div class="col-md-9">
